...
android {
    ...
    signingConfigs {
        // Debug uses the default Android debug keystore (auto-generated by SDK)
        getByName("debug") {
            // No custom config needed — uses ~/.android/debug.keystore
        }
        // Release: set these env vars or use Android Studio to generate a keystore
        create("release") {
