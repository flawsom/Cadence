...
class CadenceWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        val tasks = try {
            val db = unifies.cadence.core.database.di.DatabaseModule.provideDatabase(context)
            val dao = db.taskDao()
            ...
            Pair(emptyList<unifies.cadence.core.database.entity.TaskEntity>(), null)
        }
    ...
    private fun WidgetContent(
        ...
        Box(
            modifier = GlanceModifier
                ...
                .clickable(actionStartActivity(unifies.cadence.MainActivity::class.java)),
